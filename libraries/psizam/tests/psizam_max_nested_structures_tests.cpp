...
struct static_options_3 {
   static constexpr std::uint32_t psizam_max_nested_structures = 3;
};
struct static_options_4 {
   static constexpr std::uint32_t psizam_max_nested_structures = 4;
};
struct dynamic_options {
   std::uint32_t psizam_max_nested_structures;
};

}

BACKEND_TEST_CASE("Test psizam_max_nested_structures default", "[psizam_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test psizam_max_nested_structures unlimited", "[psizam_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, empty_options>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test psizam_max_nested_structures static fail", "[psizam_max_nested_structures_test]") {
...
BACKEND_TEST_CASE("Test psizam_max_nested_structures static pass", "[psizam_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, static_options_4>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test psizam_max_nested_structures dynamic fail", "[psizam_max_nested_structures_test]") {
...
BACKEND_TEST_CASE("Test psizam_max_nested_structures dynamic pass", "[psizam_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, dynamic_options>;
