...
struct init_backend {
   ...
   using rhf_t     = psizam::registered_host_functions<Host, execution_interface, cnv<Host>>;
...
BACKEND_TEST_CASE( "Test C-style host function system", "[C-style_host_functions_tests]") {
   wasm_allocator wa;
   using rhf_t     = psizam::registered_host_functions<standalone_function_t, execution_interface, cnv<standalone_function_t>>;
