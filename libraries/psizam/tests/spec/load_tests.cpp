...
BACKEND_TEST_CASE( "Testing wasm <load_0_wasm>", "[load_0_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "as-br-value")->to_ui32() == UINT32_C(0));
   CHECK(!bkend.call_with_return("env", "as-br_if-cond"));
   CHECK(bkend.call_with_return("env", "as-br_if-value")->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-br_if-value-cond")->to_ui32() == UINT32_C(7));
   CHECK(!bkend.call_with_return("env", "as-br_table-index"));
   CHECK(bkend.call_with_return("env", "as-br_table-value")->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-br_table-value-index")->to_ui32() == UINT32_C(6));
   CHECK(bkend.call_with_return("env", "as-return-value")->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-if-cond")->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-if-then")->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-if-else")->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-select-first", UINT32_C(0), UINT32_C(1))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-select-second", UINT32_C(0), UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-select-cond")->to_ui32() == UINT32_C(1));
   ...
   CHECK(bkend.call_with_return("env", "as-call_indirect-index")->to_ui32() == UINT32_C(4294967295));
   CHECK(!bkend.call_with_return("env", "as-local.set-value"));
   CHECK(bkend.call_with_return("env", "as-local.tee-value")->to_ui32() == UINT32_C(0));
   ...
   CHECK(bkend.call_with_return("env", "as-unary-operand")->to_ui32() == UINT32_C(32));
   CHECK(bkend.call_with_return("env", "as-binary-left")->to_ui32() == UINT32_C(10));
   CHECK(bkend.call_with_return("env", "as-binary-right")->to_ui32() == UINT32_C(10));
   CHECK(bkend.call_with_return("env", "as-test-operand")->to_ui32() == UINT32_C(1));
