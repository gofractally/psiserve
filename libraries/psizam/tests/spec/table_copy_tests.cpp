...
// Host functions imported by table_copy spec tests (module "a", ef0-ef4).
// Each efN() returns N as i32.
namespace {
   int32_t tc_ef0() { return 0; }
   int32_t tc_ef1() { return 1; }
   int32_t tc_ef2() { return 2; }
   int32_t tc_ef3() { return 3; }
   int32_t tc_ef4() { return 4; }

   using table_copy_rhf = registered_host_functions<standalone_function_t>;

   const bool _table_copy_imports_registered = [] {
      table_copy_rhf::add<&tc_ef0>("a", "ef0");
      table_copy_rhf::add<&tc_ef1>("a", "ef1");
      table_copy_rhf::add<&tc_ef2>("a", "ef2");
      table_copy_rhf::add<&tc_ef3>("a", "ef3");
      table_copy_rhf::add<&tc_ef4>("a", "ef4");
      return true;
   }();
}
...
BACKEND_TEST_CASE( "Testing wasm <table_copy_1_wasm>", "[table_copy_1_wasm_tests]" ) {
   using backend_t = backend<table_copy_rhf, TestType>;
