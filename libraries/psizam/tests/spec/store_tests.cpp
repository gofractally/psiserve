...
BACKEND_TEST_CASE( "Testing wasm <store_0_wasm>", "[store_0_wasm_tests]" ) {
   ...
   auto code = read_wasm( std::string(wasm_directory) + "store.0.wasm");
