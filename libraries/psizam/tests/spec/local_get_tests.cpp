...
BACKEND_TEST_CASE( "Testing wasm <local_get_0_wasm>", "[local_get_0_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "as-loop-value", UINT32_C(7))->to_ui32() == UINT32_C(7));
   CHECK(bkend.call_with_return("env", "as-br-value", UINT32_C(8))->to_ui32() == UINT32_C(8));
   CHECK(bkend.call_with_return("env", "as-br_if-value", UINT32_C(9))->to_ui32() == UINT32_C(9));
   CHECK(bkend.call_with_return("env", "as-br_if-value-cond", UINT32_C(10))->to_ui32() == UINT32_C(10));
   CHECK(bkend.call_with_return("env", "as-br_table-value", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-return-value", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-if-then", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-if-else", UINT32_C(0))->to_ui32() == UINT32_C(0));
   ...
   CHECK(bit_cast<uint64_t>(bkend.call_with_return("env", "read", UINT64_C(1), bit_cast<float>(UINT32_C(1073741824)), bit_cast<double>(UINT64_C(4614613358185178726)), UINT32_C(4), UINT32_C(5))->to_f64()) == UINT64_C(4630094481904264806));
}
