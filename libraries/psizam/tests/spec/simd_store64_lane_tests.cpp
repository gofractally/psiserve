...
BACKEND_TEST_CASE( "Testing wasm <simd_store64_lane_0_wasm>", "[simd_store64_lane_0_wasm_tests]" ) {
...
BACKEND_TEST_CASE( "Testing wasm <simd_store64_lane_1_wasm>", "[simd_store64_lane_1_wasm_tests]" ) {
   using backend_t = backend<standalone_function_t, TestType>;
   auto code = read_wasm( std::string(wasm_directory) + "simd_store64_lane.1.wasm");
   CHECK_THROWS_AS(backend_t(code, nullptr), std::exception);
}

BACKEND_TEST_CASE( "Testing wasm <simd_store64_lane_2_wasm>", "[simd_store64_lane_2_wasm_tests]" ) {
   using backend_t = backend<standalone_function_t, TestType>;
   auto code = read_wasm( std::string(wasm_directory) + "simd_store64_lane.2.wasm");
   CHECK_THROWS_AS(backend_t(code, nullptr), std::exception);
}

BACKEND_TEST_CASE( "Testing wasm <simd_store64_lane_3_wasm>", "[simd_store64_lane_3_wasm_tests]" ) {
   using backend_t = backend<standalone_function_t, TestType>;
   auto code = read_wasm( std::string(wasm_directory) + "simd_store64_lane.3.wasm");
   CHECK_THROWS_AS(backend_t(code, nullptr), std::exception);
}
