...
BACKEND_TEST_CASE( "Testing wasm <select_0_wasm>", "[select_0_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "as-select-last", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-select-last", UINT32_C(1))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-loop-first", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-loop-first", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-loop-mid", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-loop-mid", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-loop-last", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-loop-last", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(!bkend.call_with_return("env", "as-if-condition", UINT32_C(0)));
   CHECK(!bkend.call_with_return("env", "as-if-condition", UINT32_C(1)));
   CHECK(bkend.call_with_return("env", "as-if-then", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-if-then", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-if-else", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-if-else", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-br_if-first", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-br_if-first", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-br_if-last", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-br_if-last", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-br_table-first", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-br_table-first", UINT32_C(1))->to_ui32() == UINT32_C(2));
   ...
   CHECK(bkend.call_with_return("env", "as-call_indirect-first", UINT32_C(0))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-call_indirect-first", UINT32_C(1))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-call_indirect-mid", UINT32_C(0))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-call_indirect-mid", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK_THROWS_AS(bkend("env", "as-call_indirect-last", UINT32_C(0)), std::exception);
   ...
   CHECK(bkend.call_with_return("env", "as-memory.grow-value", UINT32_C(1))->to_ui32() == UINT32_C(3));
   CHECK(bkend.call_with_return("env", "as-call-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-call-value", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-return-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   ...
   CHECK(bkend.call_with_return("env", "as-br-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-br-value", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-local.set-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-local.set-value", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-local.tee-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-local.tee-value", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-global.set-value", UINT32_C(0))->to_ui32() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "as-global.set-value", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-load-operand", UINT32_C(0))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-load-operand", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-unary-operand", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-unary-operand", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-binary-operand", UINT32_C(0))->to_ui32() == UINT32_C(4));
   CHECK(bkend.call_with_return("env", "as-binary-operand", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-test-operand", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-test-operand", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-compare-left", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-compare-left", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-compare-right", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-compare-right", UINT32_C(1))->to_ui32() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "as-convert-operand", UINT32_C(0))->to_ui32() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "as-convert-operand", UINT32_C(1))->to_ui32() == UINT32_C(1));
}
