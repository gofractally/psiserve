...
#define MEMORY_DUMP_CONST_VISIT(name, code) \
   ...
   struct memory_dump_visitor {
      ...
      PSIZAM_CONTROL_FLOW_OPS(MEMORY_DUMP_CONTROL_FLOW_VISIT)
      PSIZAM_BR_TABLE_OP(MEMORY_DUMP_BR_TABLE_VISIT)
      PSIZAM_RETURN_OP(MEMORY_DUMP_OP_VISIT)
      PSIZAM_CALL_OPS(MEMORY_DUMP_CALL_VISIT)
      PSIZAM_CALL_IMM_OPS(MEMORY_DUMP_CALL_VISIT)
      PSIZAM_PARAMETRIC_OPS(MEMORY_DUMP_OP_VISIT)
      PSIZAM_VARIABLE_ACCESS_OPS(MEMORY_DUMP_VARIABLE_ACCESS_VISIT)
      PSIZAM_I32_CONSTANT_OPS(MEMORY_DUMP_CONST_VISIT)
      PSIZAM_I64_CONSTANT_OPS(MEMORY_DUMP_CONST_VISIT)
      PSIZAM_F32_CONSTANT_OPS(MEMORY_DUMP_CONST_VISIT)
      PSIZAM_F64_CONSTANT_OPS(MEMORY_DUMP_CONST_VISIT)
      PSIZAM_COMPARISON_OPS(MEMORY_DUMP_OP_VISIT)
      PSIZAM_NUMERIC_OPS(MEMORY_DUMP_OP_VISIT)
      PSIZAM_CONVERSION_OPS(MEMORY_DUMP_OP_VISIT)
      PSIZAM_EXIT_OP(MEMORY_DUMP_OP_VISIT)
      PSIZAM_EMPTY_OPS(MEMORY_DUMP_OP_VISIT)
      PSIZAM_ERROR_OPS(MEMORY_DUMP_OP_VISIT)
      template <typename T>
