...
// define parallel v1 (psio::) and v3 (psio3::) types with matching
...
namespace
{
   ...
   {
      auto b1 = as_chars(psio::convert_to_ssz(v1));
      auto b3 = as_chars(psio3::encode(psio3::ssz{}, v3));
      require_same_bytes("ssz", b1, b3);
      REQUIRE(psio::convert_from_ssz<V1>(b1) == v1);
      REQUIRE(psio3::decode<V3>(psio3::ssz{}, cview(b3)) == v3);
   }
   ...
   {
      auto b1_16 = as_chars(
         psio::convert_to_pssz<psio::frac_format_pssz16>(v1));
      auto b3_16 = as_chars(psio3::encode(psio3::pssz16{}, v3));
      require_same_bytes("pssz16", b1_16, b3_16);

      auto b1_32 = as_chars(
         psio::convert_to_pssz<psio::frac_format_pssz32>(v1));
      auto b3_32 = as_chars(psio3::encode(psio3::pssz32{}, v3));
      ...
      auto b1_auto = as_chars(
         psio::convert_to_pssz<psio::auto_pssz_format_t<V1>>(v1));
      auto b3_auto = as_chars(psio3::encode(psio3::pssz{}, v3));
   ...
   {
      auto b1 = as_chars(psio::to_frac(v1));
      auto b3 = as_chars(psio3::encode(psio3::frac32{}, v3));
      require_same_bytes("frac", b1, b3);

      auto b1_16 = as_chars(psio::to_frac16(v1));
      auto b3_16 = as_chars(psio3::encode(psio3::frac16{}, v3));
   ...
   {
      auto b1 = as_chars(psio::convert_to_bin(v1));
      auto b3 = as_chars(psio3::encode(psio3::bin{}, v3));
      require_same_bytes("bin", b1, b3);
      REQUIRE(psio::convert_from_bin<V1>(b1) == v1);
      REQUIRE(psio3::decode<V3>(psio3::bin{}, cview(b3)) == v3);
   }

   template <typename V1, typename V3>
   void require_borsh_oracle(const V1& v1, const V3& v3)
   {
      auto b1 = as_chars(psio::convert_to_borsh(v1));
      auto b3 = as_chars(psio3::encode(psio3::borsh{}, v3));
      require_same_bytes("borsh", b1, b3);
      REQUIRE(psio::convert_from_borsh<V1>(b1) == v1);
      REQUIRE(psio3::decode<V3>(psio3::borsh{}, cview(b3)) == v3);
   }

   template <typename V1, typename V3>
   void require_bincode_oracle(const V1& v1, const V3& v3)
   {
      auto b1 = as_chars(psio::convert_to_bincode(v1));
      auto b3 = as_chars(psio3::encode(psio3::bincode{}, v3));
      require_same_bytes("bincode", b1, b3);
      REQUIRE(psio::convert_from_bincode<V1>(b1) == v1);
      REQUIRE(psio3::decode<V3>(psio3::bincode{}, cview(b3)) == v3);
   }

   template <typename V1, typename V3>
   void require_key_oracle(const V1& v1, const V3& v3)
   {
      auto b1 = as_chars(psio::convert_to_key(v1));
      auto b3 = as_chars(psio3::encode(psio3::key{}, v3));
   ...
   {
      auto b1 = as_chars(psio::convert_to_avro(v1));
      auto b3 = as_chars(psio3::encode(psio3::avro{}, v3));
      require_same_bytes("avro", b1, b3);
      REQUIRE(psio::convert_from_avro<V1>(b1) == v1);
      REQUIRE(psio3::decode<V3>(psio3::avro{}, cview(b3)) == v3);
   }
}  // namespace
