          ...
          "[frac][parity][primitive]")
{
   ...
   auto          av = psio::convert_to_frac(v);
   auto          bv = psio3::encode(psio3::frac32{}, v);
   REQUIRE(av == bv);
}
...
{
   REQUIRE(psio::convert_to_frac(true) ==
           psio3::encode(psio3::frac32{}, true));
   REQUIRE(psio::convert_to_frac(false) ==
           psio3::encode(psio3::frac32{}, false));
}

TEST_CASE("frac parity: float / double", "[frac][parity][primitive]")
{
   REQUIRE(psio::convert_to_frac(3.14159f) ==
           psio3::encode(psio3::frac32{}, 3.14159f));
   REQUIRE(psio::convert_to_frac(2.718281828459045) ==
           psio3::encode(psio3::frac32{}, 2.718281828459045));
}
          ...
          "[frac][parity][array]")
{
   ...
   REQUIRE(psio::convert_to_frac(arr) ==
           psio3::encode(psio3::frac32{}, arr));
}
          ...
          "[frac][parity][vector]")
{
   ...
   REQUIRE(psio::convert_to_frac(v) == psio3::encode(psio3::frac32{}, v));
}

TEST_CASE("frac parity: std::string", "[frac][parity][string]")
{
   std::string s = "hello world";
   auto        av = psio::convert_to_frac(s);
   auto        bv = psio3::encode(psio3::frac32{}, s);
   INFO("v1: " << hex_dump(av));
   INFO("v3: " << hex_dump(bv));
   REQUIRE(av == bv);
}
...
{
   std::string s;
   REQUIRE(psio::convert_to_frac(s) == psio3::encode(psio3::frac32{}, s));
}
          ...
          "[frac][parity][optional]")
{
   ...
   auto                         av = psio::convert_to_frac(o);
   auto                         bv = psio3::encode(psio3::frac32{}, o);
   INFO("v1: " << hex_dump(av));
   INFO("v3: " << hex_dump(bv));
   REQUIRE(av == bv);
}
          ...
          "[frac][parity][optional]")
{
   ...
   REQUIRE(psio::convert_to_frac(o) == psio3::encode(psio3::frac32{}, o));
}
          ...
          "[frac][parity][record]")
{
   v1_frac::Point a{3, -7};
   v3_frac::Point b{3, -7};
   auto           av = psio::convert_to_frac(a);
   auto           bv = psio3::encode(psio3::frac32{}, b);
   INFO("v1: " << hex_dump(av));
   INFO("v3: " << hex_dump(bv));
   REQUIRE(av == bv);
}
          ...
          "[frac][parity][record][round-trip]")
{
   ...
   auto           av = psio::convert_to_frac(a);
   auto back = psio3::decode<v3_frac::Point>(psio3::frac32{},
          ...
          "[frac][parity][record][round-trip]")
{
   ...
   auto          av = psio::convert_to_frac(a);
   auto back = psio3::decode<v3_frac::Blob>(psio3::frac32{},
                                             std::span<const char>{av});
          ...
          "[frac][parity][record][round-trip]")
{
   ...
   auto          bv = psio3::encode(psio3::frac32{}, b);
   v1_frac::Blob back;
   REQUIRE(psio::from_frac<v1_frac::Blob>(
          ...
          "[frac][parity][variant]")
{
   ...
   REQUIRE(psio::convert_to_frac(V{std::uint32_t{0xDEADBEEF}}) ==
           psio3::encode(psio3::frac32{},
                         V{std::uint32_t{0xDEADBEEF}}));
   REQUIRE(psio::convert_to_frac(V{std::string("xyz")}) ==
           psio3::encode(psio3::frac32{}, V{std::string("xyz")}));
}
...
TEST_CASE("frac round-trip: std::variant", "[frac][variant][round-trip]")
{
   ...
   auto   bv = psio3::encode(psio3::frac32{}, in);
   auto   out =
      psio3::decode<V>(psio3::frac32{}, std::span<const char>{bv});
   REQUIRE(out.index() == 1);
...
TEST_CASE("frac parity: uint128", "[frac][parity][extint]")
{
   ...
   psio3::uint128 v3v =
      (static_cast<psio3::uint128>(0x1234567890ABCDEFULL) << 64) |
      0xFEDCBA9876543210ULL;
   REQUIRE(psio::convert_to_frac(v1v) ==
           psio3::encode(psio3::frac32{}, v3v));
}
