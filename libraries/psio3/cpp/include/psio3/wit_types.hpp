...
// generator builds them from PSIO3_REFLECT'd C++ types.
//
...
namespace psio3 {
   ...
   PSIO3_REFLECT(wit_attribute, name, arg_key, arg_value)
   ...
   PSIO3_REFLECT(wit_named_type, name, type_idx, attributes)
   ...
   PSIO3_REFLECT(wit_type_def, name, kind, fields, element_type_idx,
   ...
   PSIO3_REFLECT(wit_func, name, params, results, core_func_idx, attributes)
   ...
   PSIO3_REFLECT(wit_interface, name, type_idxs, func_idxs, attributes)
   ...
   PSIO3_REFLECT(wit_world, package, name, wit_source, types, funcs,
