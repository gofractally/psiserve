...
PSIO_REFLECT(ip_address_family)
...
PSIO_REFLECT(ipv4_address, octets)

struct ipv6_address
{
   uint16_t segments[8];
};
PSIO_REFLECT(ipv6_address, segments)
...
PSIO_REFLECT(ipv4_socket_address, port, address)
...
PSIO_REFLECT(ipv6_socket_address, port, flow_info, address, scope_id)
...
struct network : psio::wit_resource {};
PSIO_REFLECT(network)
...
PSIO_REFLECT(shutdown_type)

// ── tcp-socket resource ──────────────────────────────────────────────

struct tcp_socket : psio::wit_resource {};
PSIO_REFLECT(tcp_socket)

// ── udp-socket resource ──────────────────────────────────────────────

struct udp_socket : psio::wit_resource {};
PSIO_REFLECT(udp_socket)

// ── udp datagram stream resources ────────────────────────────────────

struct incoming_datagram_stream : psio::wit_resource {};
PSIO_REFLECT(incoming_datagram_stream)

struct outgoing_datagram_stream : psio::wit_resource {};
PSIO_REFLECT(outgoing_datagram_stream)

// ── resolve-address-stream resource ──────────────────────────────────

struct resolve_address_stream : psio::wit_resource {};
PSIO_REFLECT(resolve_address_stream)
...
PSIO_REFLECT(incoming_datagram, data, remote_address)
...
PSIO_REFLECT(outgoing_datagram, data, remote_address)
...
struct wasi_sockets_tcp
{
   ...
   static inline psio::own<pollable> tcp_socket_subscribe(
       psio::borrow<tcp_socket> /*self*/)
   {
...
struct wasi_sockets_udp
{
   ...
   static inline socket_result<
       std::tuple<psio::own<incoming_datagram_stream>, psio::own<outgoing_datagram_stream>>>
   udp_socket_stream(
       psio::borrow<udp_socket> /*self*/,
       std::optional<ip_socket_address> /*remote_address*/)
   {
   ...
   static inline psio::own<pollable> udp_socket_subscribe(
       psio::borrow<udp_socket> /*self*/)
   {
      return psio::own<pollable>{0};
   }
   ...
   static inline psio::own<pollable> incoming_datagram_stream_subscribe(
       psio::borrow<incoming_datagram_stream> /*self*/)
   {
      return psio::own<pollable>{0};
   }
   ...
   static inline psio::own<pollable> outgoing_datagram_stream_subscribe(
       psio::borrow<outgoing_datagram_stream> /*self*/)
   {
      return psio::own<pollable>{0};
   }
...
struct wasi_sockets_ip_name_lookup
{
   ...
   static inline socket_result<psio::own<resolve_address_stream>> resolve_addresses(
       psio::borrow<network> /*network*/,
       std::string /*name*/)
   {
      return sock_detail::err(network_error_code::not_supported);
   ...
   static inline psio::own<pollable> resolve_address_stream_subscribe(
       psio::borrow<resolve_address_stream> /*self*/)
   {
      return psio::own<pollable>{0};
   }
...
struct wasi_sockets_instance_network
{
   ...
   static inline psio::own<network> instance_network()
   {
      return psio::own<network>{0};
   }
};
...
PSIO_PACKAGE(wasi_sockets, "0.2.3");
...
PSIO_INTERFACE(wasi_sockets_tcp,
...
PSIO_INTERFACE(wasi_sockets_tcp_create_socket,
               types(),
               funcs(func(create_tcp_socket, address_family)))

PSIO_INTERFACE(wasi_sockets_udp,
...
PSIO_INTERFACE(wasi_sockets_udp_create_socket,
               types(),
               funcs(func(create_udp_socket, address_family)))

PSIO_INTERFACE(wasi_sockets_ip_name_lookup,
...
PSIO_INTERFACE(wasi_sockets_instance_network,
               types(),
