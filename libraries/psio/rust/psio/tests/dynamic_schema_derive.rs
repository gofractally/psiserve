...
use psio::dynamic_schema::DynamicType;
use psio::dynamic_view::{DynamicView, FromDynamicView, HashedPath, ToDynamicSchema, WireFormat};
use psio::wit::pack::WitPack;

// ── Test struct with the derive macro ──────────────────────────────────

#[derive(psio::ToDynamicSchema)]
struct Point {
    x: i32,
    y: i32,
}
...
#[derive(psio::ToDynamicSchema, Debug, PartialEq)]
struct SimpleRecord {
    id: u32,
    value: i64,
}
