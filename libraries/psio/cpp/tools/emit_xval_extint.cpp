...
int main()
{
   ...
   emit("u128_ff.ssz",   psio::convert_to_ssz(u128v));
   emit("u128_ff.pssz32", psio::convert_to_pssz<psio::frac_format_pssz32>(u128v));

   __int128 i128v = -42;
   emit("i128_neg42.ssz",   psio::convert_to_ssz(i128v));
   emit("i128_neg42.pssz32", psio::convert_to_pssz<psio::frac_format_pssz32>(i128v));
   ...
   u256v.limb[2] = 3;
   u256v.limb[3] = 4;
   emit("u256_1234.ssz",   psio::convert_to_ssz(u256v));
   emit("u256_1234.pssz32", psio::convert_to_pssz<psio::frac_format_pssz32>(u256v));
}
