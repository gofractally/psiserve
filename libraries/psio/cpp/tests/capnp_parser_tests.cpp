...
PSIO_REFLECT(PPoint, definitionWillNotChange(), x, y)
...
PSIO_REFLECT(PToken, kind, offset, length, text)
...
PSIO_REFLECT(PUser, id, name, email, age, score, tags, verified)
...
PSIO_REFLECT(PLineItem, product, qty, unit_price)
...
PSIO_REFLECT(POrder, id, customer, items, total, note)
...
PSIO_REFLECT(PShape, area, shape)
...
PSIO_REFLECT(PScalarMix, a, b, c, d, e, f, g, h, i, j, k)

// ── Basic parsing tests ─────────────────────────────────────────────────────

TEST_CASE("capnp parser: file ID", "[capnp_parser]")
{
   auto file = psio::capnp_parse(R"(
      @0xdeadbeefcafebabe;
   )");
...
TEST_CASE("capnp parser: simple struct", "[capnp_parser]")
{
   ...
   REQUIRE(s.fields[0].type.tag == psio::capnp_type_tag::float64);

   REQUIRE(s.fields[1].name == "y");
   REQUIRE(s.fields[1].ordinal == 1);
   REQUIRE(s.fields[1].type.tag == psio::capnp_type_tag::float64);
}
...
TEST_CASE("capnp parser: mixed scalar and pointer fields", "[capnp_parser]")
{
   ...
   REQUIRE(s.fields[0].type.tag == psio::capnp_type_tag::uint16);
   REQUIRE(s.fields[1].type.tag == psio::capnp_type_tag::uint32);
   REQUIRE(s.fields[2].type.tag == psio::capnp_type_tag::uint32);
   REQUIRE(s.fields[3].type.tag == psio::capnp_type_tag::text);
}
...
TEST_CASE("capnp parser: List types", "[capnp_parser]")
{
   ...
   REQUIRE(s.fields[0].type.tag == psio::capnp_type_tag::list);
   REQUIRE(s.fields[1].type.tag == psio::capnp_type_tag::list);
   REQUIRE(s.fields[2].type.tag == psio::capnp_type_tag::data);
}
...
TEST_CASE("capnp parser: nested struct reference", "[capnp_parser]")
{
   ...
   REQUIRE(outer.fields[0].type.tag == psio::capnp_type_tag::struct_);
   REQUIRE(outer.fields[0].type.referenced_type_idx == 0);  // Inner is at index 0
   REQUIRE(outer.fields[1].type.tag == psio::capnp_type_tag::text);
}
...
TEST_CASE("capnp parser: struct with enum field", "[capnp_parser]")
{
   ...
   REQUIRE(file.structs.size() == 1);
   auto& s = file.structs[0];
   REQUIRE(s.fields[0].type.tag == psio::capnp_type_tag::enum_);
...
TEST_CASE("capnp parser: union", "[capnp_parser]")
{
   ...
   REQUIRE(u.alternatives[0].type.tag == psio::capnp_type_tag::float64);

   REQUIRE(u.alternatives[1].name == "label");
   REQUIRE(u.alternatives[1].ordinal == 2);
   REQUIRE(u.alternatives[1].type.tag == psio::capnp_type_tag::text);

   REQUIRE(u.alternatives[2].name == "nothing");
   REQUIRE(u.alternatives[2].ordinal == 3);
   REQUIRE(u.alternatives[2].type.tag == psio::capnp_type_tag::void_);
}
...
TEST_CASE("capnp parser: using alias", "[capnp_parser]")
{
   ...
   REQUIRE(file.aliases[0].type.tag == psio::capnp_type_tag::uint64);

   REQUIRE(file.structs.size() == 1);
   // The field should resolve to uint64 through the alias
   REQUIRE(file.structs[0].fields[0].type.tag == psio::capnp_type_tag::uint64);
}
...
TEST_CASE("capnp parser: all builtin types", "[capnp_parser]")
{
   ...
   REQUIRE(s.fields[0].type.tag == psio::capnp_type_tag::void_);
   REQUIRE(s.fields[1].type.tag == psio::capnp_type_tag::bool_);
   REQUIRE(s.fields[2].type.tag == psio::capnp_type_tag::int8);
   REQUIRE(s.fields[3].type.tag == psio::capnp_type_tag::int16);
   REQUIRE(s.fields[4].type.tag == psio::capnp_type_tag::int32);
   REQUIRE(s.fields[5].type.tag == psio::capnp_type_tag::int64);
   REQUIRE(s.fields[6].type.tag == psio::capnp_type_tag::uint8);
   REQUIRE(s.fields[7].type.tag == psio::capnp_type_tag::uint16);
   REQUIRE(s.fields[8].type.tag == psio::capnp_type_tag::uint32);
   REQUIRE(s.fields[9].type.tag == psio::capnp_type_tag::uint64);
   REQUIRE(s.fields[10].type.tag == psio::capnp_type_tag::float32);
   REQUIRE(s.fields[11].type.tag == psio::capnp_type_tag::float64);
   REQUIRE(s.fields[12].type.tag == psio::capnp_type_tag::text);
   REQUIRE(s.fields[13].type.tag == psio::capnp_type_tag::data);
}
...
TEST_CASE("capnp parser: layout matches Point", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PPoint>;
   auto& s      = file.structs[0];
...
TEST_CASE("capnp parser: layout matches Token", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PToken>;
   auto& s      = file.structs[0];
...
TEST_CASE("capnp parser: layout matches User", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PUser>;
   auto& s      = file.structs[0];
...
TEST_CASE("capnp parser: layout matches LineItem", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PLineItem>;
   auto& s      = file.structs[0];
...
TEST_CASE("capnp parser: layout matches union (Shape)", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PShape>;
   auto& s      = file.structs[0];
...
TEST_CASE("capnp parser: layout matches all scalar types", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<PScalarMix>;
   auto& s      = file.structs[0];
...
{
   REQUIRE_THROWS_AS(
       psio::capnp_parse("@0x1; !!!"),
       psio::capnp_parse_error);
}
...
TEST_CASE("capnp parser: List(Struct) type reference", "[capnp_parser]")
{
   ...
   REQUIRE(container.fields[0].type.tag == psio::capnp_type_tag::list);
...
TEST_CASE("capnp parser: layout matches Order (nested + list)", "[capnp_parser][layout]")
{
   ...
   using layout = psio::capnp_layout<POrder>;
