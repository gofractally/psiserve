...
PSIO_REFLECT(Item, id, name, price_cents, in_stock, weight_grams)
...
auto binary = psio::generate_wit_binary<InventoryApi>("my:inventory@1.0.0");
```
...
|----------|-----------|-------------|
| C++ | `PSIO_REFLECT` macro + template metaprogramming | Inline at compile time |
...
to type structure at compile time. Once you have that (via PSIO_REFLECT,
