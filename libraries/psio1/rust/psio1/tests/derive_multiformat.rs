...
use psio1::flatbuf::builder::FbPack;
use psio1::flatbuf::unpack::FbUnpack;
use psio1::wit::layout::WitLayout;
use psio1::wit::pack::WitPack;
use psio1::wit::view::WitUnpack;

// ── Test struct: scalars only ───────────────────────────────────────────

#[derive(Debug, Clone, PartialEq, psio1::CapnpPack, psio1::CapnpUnpack, psio1::FbPack, psio1::FbUnpack, psio1::WitPack, psio1::WitUnpack)]
...
#[derive(Debug, Clone, PartialEq, psio1::CapnpPack, psio1::CapnpUnpack)]
#[fracpack(fracpack_mod = "psio")]
struct WithBoolVec {
    flags: Vec<bool>,
}
