...
namespace eth::fulu
{
   ...
   struct ExecutionPayloadHeader
   {
      ...
      psio1::bounded_list<std::uint8_t, MAX_EXTRA_DATA_BYTES> extra_data;
      psio1::uint256     base_fee_per_gas;
      Bytes32           block_hash;
   ...
   struct BeaconState
   {
      ...
      psio1::bounded_list<Root, HISTORICAL_ROOTS_LIMIT>  historical_roots;
      Eth1Data                                          eth1_data;
      psio1::bounded_list<Eth1Data,
                          EPOCHS_PER_ETH1_VOTING_PERIOD * SLOTS_PER_EPOCH>
                                                        eth1_data_votes;
      std::uint64_t                                     eth1_deposit_index;
      psio1::bounded_list<Validator, VALIDATOR_REGISTRY_LIMIT> validators;
      psio1::bounded_list<Gwei, VALIDATOR_REGISTRY_LIMIT>      balances;
      std::array<Bytes32, EPOCHS_PER_HISTORICAL_VECTOR> randao_mixes;
      std::array<Gwei, EPOCHS_PER_SLASHINGS_VECTOR>     slashings;

      // Altair
      psio1::bounded_list<ParticipationFlag, VALIDATOR_REGISTRY_LIMIT>
                                                        previous_epoch_participation;
      psio1::bounded_list<ParticipationFlag, VALIDATOR_REGISTRY_LIMIT>
                                                        current_epoch_participation;

      // Finality
      psio1::bitvector<JUSTIFICATION_BITS_LENGTH>        justification_bits;
      Checkpoint                                        previous_justified_checkpoint;
      Checkpoint                                        current_justified_checkpoint;
      Checkpoint                                        finalized_checkpoint;

      // Altair (continued)
      psio1::bounded_list<std::uint64_t, VALIDATOR_REGISTRY_LIMIT> inactivity_scores;
      ...
      psio1::bounded_list<HistoricalSummary, HISTORICAL_ROOTS_LIMIT> historical_summaries;
      ...
      psio1::bounded_list<PendingDeposit, PENDING_DEPOSITS_LIMIT> pending_deposits;
      psio1::bounded_list<PendingPartialWithdrawal,
                          PENDING_PARTIAL_WITHDRAWALS_LIMIT>      pending_partial_withdrawals;
      psio1::bounded_list<PendingConsolidation, PENDING_CONSOLIDATIONS_LIMIT>
   ...
   PSIO1_REFLECT(SyncCommittee,
                definitionWillNotChange(),
                pubkeys, aggregate_pubkey)

   PSIO1_REFLECT(ExecutionPayloadHeader,
   ...
   PSIO1_REFLECT(HistoricalSummary,
                definitionWillNotChange(),
                block_summary_root, state_summary_root)

   PSIO1_REFLECT(PendingDeposit,
                definitionWillNotChange(),
                pubkey, withdrawal_credentials, amount, signature, slot)

   PSIO1_REFLECT(PendingPartialWithdrawal,
                definitionWillNotChange(),
                validator_index, amount, withdrawable_epoch)

   PSIO1_REFLECT(PendingConsolidation,
                definitionWillNotChange(),
