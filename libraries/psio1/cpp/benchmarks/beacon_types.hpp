...
// Ethereum mainnet. Types use psio1::bounded_list / psio1::bitvector / etc.
...
namespace eth
{
   ...
   {
      psio1::bitlist<MAX_VALIDATORS_PER_COMMITTEE> aggregation_bits;
   ...
   struct BeaconState
   {
      ...
      // Eth1
      Eth1Data                                                  eth1_data;
      psio1::bounded_list<Eth1Data, SLOTS_PER_ETH1_VOTING_PERIOD> eth1_data_votes;
      ...
      psio1::bounded_list<PendingAttestation,
   ...
   PSIO1_REFLECT(ForkData,
                definitionWillNotChange(),
                current_version, genesis_validators_root)

   PSIO1_REFLECT(Checkpoint,
                definitionWillNotChange(),
                epoch, root)
