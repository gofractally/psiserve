...
// (FlatBuffer, fracpack, etc.) driven by PSIO1_REFLECT.  The Format
// tag determines how bytes are navigated; the view API is identical
// regardless of format.
//
//   auto fv = psio1::view<Order, psio1::fb>::from_buffer(fb_buf);
//   auto pv = psio1::view<Order, psio1::frac>::from_buffer(frac_buf);
//
...
// ── view_proxy — the ProxyObject for PSIO1_REFLECT's proxy<> ────────────
//
