...
//
// Usage:
//   auto world = psio1::generate_wit<MyExports>("test:pkg@1.0.0");
//   auto binary = psio1::encode_wit_binary(world);
//   // binary is a std::vector<uint8_t> ready for a component-type custom section
//
// Or directly from types:
//   auto binary = psio1::generate_wit_binary<MyExports>("test:pkg@1.0.0");
...
namespace psio1 {
   ...
   /// Generate Component Model binary directly from PSIO1_REFLECT-annotated C++ types.
