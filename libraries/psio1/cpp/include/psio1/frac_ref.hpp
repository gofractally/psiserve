...
namespace psio1
{
   ...
   // ── frac_proxy_obj: the ProxyObject for PSIO1_REFLECT's proxy<> ─────────────
   ...
   class frac_ref
   {
     ...
     public:
      ...
      // by PSIO1_REFLECT.  Each accessor returns either a nested proxy
   ...
   //
   //   auto v = psio1::view<Order, psio1::frac>::from_buffer(packed.data());
   //   v.id()                  // uint64_t
