...
namespace psio1 {
   ...
   PSIO1_REFLECT(wit_attribute, name, arg_key, arg_value)
   ...
   PSIO1_REFLECT(wit_named_type, name, type_idx, attributes)
   ...
   PSIO1_REFLECT(wit_type_def, name, kind, fields, element_type_idx, error_type_idx, method_func_idxs, attributes)
   ...
   PSIO1_REFLECT(wit_func, name, params, results, core_func_idx, attributes)
   ...
   PSIO1_REFLECT(wit_interface, name, type_idxs, func_idxs, attributes)
   ...
   PSIO1_REFLECT(wit_world, package, name, wit_source, types, funcs, exports, imports, attributes)
