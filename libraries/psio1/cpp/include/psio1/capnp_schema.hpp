// capnp_schema.hpp — Generate Cap'n Proto .capnp schema text from PSIO1_REFLECT'd C++ types
//
...
namespace psio1
{
   namespace capnp_detail
   {
                                     ...
                                     std::vector<std::string>& deps)
      {
         ...
         // capnp_layout processes fields in PSIO1_REFLECT order, expanding variants
