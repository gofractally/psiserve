...
//   psio1::uint128  — alias for unsigned __int128 (GCC/Clang extension)
//   psio1::int128   — alias for          __int128 (GCC/Clang extension)
//   psio1::uint256  — 32-byte LE unsigned integer, 4 × uint64 limbs (limb[0] = least-significant)
//
