...
// WView<T> and WOwned<T> — WASM Canonical ABI type projections from PSIO1_REFLECT.
//
...
//   };
//   PSIO1_REFLECT(Transfer, from, to, amount, memo_lines)
//
...
namespace psio1 {
   ...
   // ── WView proxy object ───────────────────────────────────────────────────
   //
   // Satisfies the PSIO1_REFLECT proxy protocol: get<I, MemberPtr>() returns
