...
//
//   psio1::bitvector<N>  — fixed-length N bits, packed (ceil(N/8) bytes)
//   psio1::bitlist<N>    — variable-length 0..N bits, packed
//
...
namespace psio1
{
   ...
   // Conversions between std::bitset<N> and psio1::bitvector<N>
   //
