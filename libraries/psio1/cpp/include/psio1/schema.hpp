...
namespace psio1
{
   ...
   namespace schema_types
   {
      ...
      PSIO1_REFLECT(Attribute, name, value)
      ...
      PSIO1_REFLECT(Object, members, attributes)
      ...
      PSIO1_REFLECT(Struct, members, attributes)
      ...
      PSIO1_REFLECT(Resource, name, methods, attributes)
      ...
      PSIO1_REFLECT(Array, type, len)

      struct List
      {
         Box<AnyType> type;
      };
      PSIO1_REFLECT_TYPENAME(List)
      ...
      // psio1::bounded_list<T, N>. Kept distinct from List so unbounded consumers
      ...
      PSIO1_REFLECT(BoundedList, type, maxCount)
      ...
      PSIO1_REFLECT(Int, bits, isSigned)
      ...
      PSIO1_REFLECT(Float, exp, mantissa)
      ...
      PSIO1_REFLECT(Variant, members, attributes)
      ...
      PSIO1_REFLECT_TYPENAME(FracPack)
      ...
      PSIO1_REFLECT_TYPENAME(AnyType)
      ...
      PSIO1_REFLECT(FunctionType, params, result)
      ...
      PSIO1_REFLECT(Member, name, type, attributes)
      ...
      PSIO1_REFLECT(Package, name, version, attributes)
      ...
      PSIO1_REFLECT(UseItem, name, alias)
      ...
      PSIO1_REFLECT(Use, package, interface_name, version, items)
      ...
      PSIO1_REFLECT(UseRef, package, interface_name)
      ...
      PSIO1_REFLECT(Func, name, params, result, attributes)
      ...
      PSIO1_REFLECT(Interface, name, type_names, funcs, attributes)
      ...
      PSIO1_REFLECT(World, name, imports, exports, attributes)
      ...
      PSIO1_REFLECT(Schema, package, interfaces, worlds, uses, types)
      ...
      ///   auto v      = psio1::compile(schema, "MyType");
      ///   auto result = psio1::validate_frac(bytes, v);   // validation_t
      ///
      ...
      {
         using psio1::get_type_name;
         using psio1::psio_is_untagged;
      ...
      class SchemaBuilder
      {
        public:
         ...
         AnyType insert()
         {
            ...
            if (inserted)
            {
               ...
               else if constexpr (std::is_same_v<T, psio1::uint128>)
               {
                  schema.insert(name, Int{.bits = 128, .isSigned = false});
               }
               else if constexpr (std::is_same_v<T, psio1::int128>)
               {
                  schema.insert(name, Int{.bits = 128, .isSigned = true});
               }
               else if constexpr (std::is_same_v<T, psio1::uint256>)
               {
               ...
               {
                  auto members = psio1::apply_member_templates(
                  ...
                  // PSIO1_REFLECT flags: canonical() and final() roll into the
               ...
               if constexpr (psio_custom_schema(static_cast<T*>(nullptr)))
               {
                  ...
                  item       = Custom{.type = std::move(item), .id = psio1::get_type_name<T>()};
               }
            }
            return Type{std::move(name)};
         }
         // Walk the compile-time world registry populated by
         // PSIO1_WORLD / PSIO1_INTERFACE / PSIO1_USE / PSIO1_PACKAGE,
         ...
         //
         // Function pointers declared in PSIO1_INTERFACE are not yet
         ...
         {
            using info             = ::psio1::detail::world_info<WorldTag>;
        ...
        private:
         ...
         {
            using u = ::psio1::detail::use_info<UseTag>;
            Use use;
         ...
         {
            using info = ::psio1::detail::interface_info<IfaceTag>;
            Interface iface;
         ...
         void add_interface_func(Interface& iface)
         {
            ...
            // (no link-time definition required). See PSIO1_IFACE_FN_TYPE.
