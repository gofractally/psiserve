...
//   PSIO1_TYPE_ATTRS(T, tags...)
//   PSIO1_FIELD_ATTRS(T, FIELD, tags...)
// and — when used inside PSIO1_REFLECT — the inline forms
...
//
// These live in psio1:: so ADL always finds them (type_attrs_key<T> has
...
//
//   PSIO1_TYPE_ATTRS(MyRecord, psio1::canonical_tag{}, psio1::final_tag{})
//
// Expands to an ADL-visible overload in the current namespace.
#define PSIO1_TYPE_ATTRS(T, ...)                                      \
   constexpr auto psio_type_attrs_lookup(::psio1::type_attrs_key<T>)  \
   {                                                                 \
...
#define PSIO1_FIELD_ATTRS(T, FIELD, ...)                                   \
   constexpr auto psio_member_attrs_lookup(                               \
       ::psio1::member_attrs_key<T, &T::FIELD>)                            \
   {                                                                      \
      return ::std::tuple{__VA_ARGS__};                                   \
   }
