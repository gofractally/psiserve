...
struct capnp_runtime_schema
{
   ...
   {
      std::vector<psio1::dynamic_field_desc> sorted_fields;
      std::vector<std::string>              field_names;
      std::vector<const char*>              ordered_names;
      std::vector<uint8_t>                  tags;
      psio1::dynamic_schema                  schema;
   };
   ...
   void build(const psio1::capnp_parsed_file& file)
   {
      ...
      for (size_t si = 0; si < file.structs.size(); ++si)
      {
         ...
         for (size_t i = 0; i < nfields; ++i)
         {
            ...
            df.name_hash       = psio1::xxh64_hash(pf.name);
         ...
         std::vector<psio1::dynamic_field_desc> sorted(nfields);
         for (size_t i = 0; i < nfields; ++i)
      ...
      for (size_t si = 0; si < file.structs.size(); ++si)
      {
         ...
         for (size_t i = 0; i < ss->sorted_fields.size(); ++i)
         {
            ...
            for (const auto& pf : ps.fields)
            {
               if (pf.name == fname)
               {
                  if (pf.type.tag == psio1::capnp_type_tag::struct_)
                  {
                  ...
                  else if (pf.type.tag == psio1::capnp_type_tag::list)
                  {
   ...
   const psio1::dynamic_schema* find(const std::string& name,
                                    const psio1::capnp_parsed_file& file) const
   {
   ...
   const psio1::dynamic_schema* first() const
   {
      if (!schemas.empty())
   ...
   const psio1::dynamic_schema* last() const
   {
      if (!schemas.empty())
   ...
   static psio1::dynamic_type capnp_tag_to_dynamic(psio1::capnp_type_tag tag)
   {
      switch (tag)
      {
         case psio1::capnp_type_tag::void_:
            return psio1::dynamic_type::t_void;
         case psio1::capnp_type_tag::bool_:
            return psio1::dynamic_type::t_bool;
         case psio1::capnp_type_tag::int8:
            return psio1::dynamic_type::t_i8;
         case psio1::capnp_type_tag::int16:
            return psio1::dynamic_type::t_i16;
         case psio1::capnp_type_tag::int32:
            return psio1::dynamic_type::t_i32;
         case psio1::capnp_type_tag::int64:
            return psio1::dynamic_type::t_i64;
         case psio1::capnp_type_tag::uint8:
            return psio1::dynamic_type::t_u8;
         case psio1::capnp_type_tag::uint16:
            return psio1::dynamic_type::t_u16;
         case psio1::capnp_type_tag::uint32:
            return psio1::dynamic_type::t_u32;
         case psio1::capnp_type_tag::uint64:
            return psio1::dynamic_type::t_u64;
         case psio1::capnp_type_tag::float32:
            return psio1::dynamic_type::t_f32;
         case psio1::capnp_type_tag::float64:
            return psio1::dynamic_type::t_f64;
         case psio1::capnp_type_tag::text:
            return psio1::dynamic_type::t_text;
         case psio1::capnp_type_tag::data:
            return psio1::dynamic_type::t_data;
         case psio1::capnp_type_tag::list:
            return psio1::dynamic_type::t_vector;
         case psio1::capnp_type_tag::struct_:
            return psio1::dynamic_type::t_struct;
         case psio1::capnp_type_tag::enum_:
            return psio1::dynamic_type::t_u16;  // capnp enums are u16
         case psio1::capnp_type_tag::any_ptr:
            return psio1::dynamic_type::t_void;
         default:
            return psio1::dynamic_type::t_void;
      }
   ...
   static uint8_t capnp_tag_byte_size(psio1::capnp_type_tag tag)
   {
      switch (tag)
      {
         case psio1::capnp_type_tag::bool_:
...
static void write_json(std::ostream& out, const psio1::dynamic_view<psio1::cp>& dv, int indent = 0);
...
static void write_json(std::ostream& out, const psio1::dynamic_view<psio1::cp>& dv, int indent)
{
   auto info = dv.type();

   psio1::dynamic_type kind = info.kind;
   if (kind == psio1::dynamic_type::t_variant)
      kind = info.active_kind;

   switch (kind)
   {
      case psio1::dynamic_type::t_void:
         out << "null";
         break;

      case psio1::dynamic_type::t_bool:
         out << (static_cast<bool>(dv) ? "true" : "false");
         break;

      case psio1::dynamic_type::t_i8:
      case psio1::dynamic_type::t_i16:
      case psio1::dynamic_type::t_i32:
      case psio1::dynamic_type::t_i64:
      {
      ...
      case psio1::dynamic_type::t_u8:
      case psio1::dynamic_type::t_u16:
      case psio1::dynamic_type::t_u32:
      case psio1::dynamic_type::t_u64:
      {
         uint64_t v = 0;
         switch (kind)
         {
      ...
      case psio1::dynamic_type::t_text:
         write_json_string(out, static_cast<std::string_view>(dv));
         break;

      case psio1::dynamic_type::t_data:
      {
      ...
      case psio1::dynamic_type::t_vector:
      {
         size_t len = dv.size();
         if (len == 0)
         {
      ...
      case psio1::dynamic_type::t_struct:
      {
         ...
         else
         {
            ...
            for (size_t i = 0; i < names.size(); ++i)
            {
               ...
               try
               {
                  auto child = dv[psio1::field_name{names[i]}];
      ...
      case psio1::dynamic_type::t_variant:
...
static void print_capnp_schema_summary(const psio1::capnp_parsed_file& file)
{
...
static void print_fbs_schema_summary(const psio1::fbs_schema& schema)
{
   ...
   for (const auto& t : schema.types)
   {
      ...
      switch (t.kind)
      {
         case psio1::fbs_type_kind::table_:
            kind_str = "table";
            break;
         case psio1::fbs_type_kind::struct_:
            kind_str = "struct";
            break;
         case psio1::fbs_type_kind::enum_:
            kind_str = "enum";
            break;
         case psio1::fbs_type_kind::union_:
            kind_str = "union";
            break;
      }
      std::cout << "    " << kind_str << " " << t.name;
      if (t.kind == psio1::fbs_type_kind::table_ || t.kind == psio1::fbs_type_kind::struct_)
         std::cout << " (" << t.fields.size() << " fields)";
      else if (t.kind == psio1::fbs_type_kind::enum_)
         std::cout << " (" << t.enum_values.size() << " values)";
      else if (t.kind == psio1::fbs_type_kind::union_)
      ...
      if (t.kind == psio1::fbs_type_kind::table_ || t.kind == psio1::fbs_type_kind::struct_)
      {
         for (const auto& f : t.fields)
         {
            ...
            switch (f.type)
            {
               case psio1::fbs_base_type::bool_:
                  type_str = "bool";
                  break;
               case psio1::fbs_base_type::int8_:
                  type_str = "byte";
                  break;
               case psio1::fbs_base_type::uint8_:
                  type_str = "ubyte";
                  break;
               case psio1::fbs_base_type::int16_:
                  type_str = "short";
                  break;
               case psio1::fbs_base_type::uint16_:
                  type_str = "ushort";
                  break;
               case psio1::fbs_base_type::int32_:
                  type_str = "int";
                  break;
               case psio1::fbs_base_type::uint32_:
                  type_str = "uint";
                  break;
               case psio1::fbs_base_type::int64_:
                  type_str = "long";
                  break;
               case psio1::fbs_base_type::uint64_:
                  type_str = "ulong";
                  break;
               case psio1::fbs_base_type::float32_:
                  type_str = "float";
                  break;
               case psio1::fbs_base_type::float64_:
                  type_str = "double";
                  break;
               case psio1::fbs_base_type::string_:
                  type_str = "string";
                  break;
               case psio1::fbs_base_type::vector_:
                  type_str = "vector";
                  break;
               case psio1::fbs_base_type::table_:
                  type_str = "table";
                  break;
               case psio1::fbs_base_type::struct_:
                  type_str = "struct";
                  break;
               case psio1::fbs_base_type::enum_:
                  type_str = "enum";
                  break;
               case psio1::fbs_base_type::union_:
                  type_str = "union";
                  break;
               default:
                  type_str = "none";
            ...
            if (t.kind == psio1::fbs_type_kind::table_)
...
Usage:
  ...
  psio-tool codegen <schema-format> <schema-file> --lang <language> [--output <file>]
      ...
      C++/Rust output uses PSIO1_REFLECT / Pack/Unpack derives.
...
static int cmd_schema(int argc, char** argv)
{
   ...
   try
   {
      ...
      {
         auto file = psio1::capnp_parse(schema_text);
      ...
      {
         auto schema = psio1::fbs_parse(schema_text);
   ...
   catch (const psio1::capnp_parse_error& e)
   {
      std::cerr << "error: " << e.what() << "\n";
      return 1;
   }
   catch (const psio1::fbs_parse_error& e)
   {
      std::cerr << "error: " << e.what() << "\n";
      return 1;
   }
...
static int cmd_validate(int argc, char** argv)
{
   ...
   try
   {
      if (fmt == format_id::capnp)
      {
         ...
         bool valid = psio1::validate_capnp(data.data(), data.size());
         if (valid)
         {
            std::cout << "valid\n";
            return 0;
...
static int cmd_inspect(int argc, char** argv)
{
   ...
   try
   {
      if (fmt == format_id::capnp)
      {
         ...
         const psio1::dynamic_schema* schema = nullptr;
         if (!type_name.empty())
         {
         ...
         if (!psio1::validate_capnp(data.data(), data.size()))
         {
         ...
         auto           root =
             psio1::capnp_detail::resolve_struct_ptr(msg + 8);  // skip segment table

         // Create dynamic view
         psio1::dynamic_view<psio1::cp> dv(root, schema);
      ...
      {
         auto fbs = psio1::fbs_parse(schema_text);
         if (fbs.types.empty())
         {
...
static int cmd_convert(int argc, char** argv)
{
   ...
   try
   {
      if (src_fmt == format_id::capnp)
      {
         ...
         // Resolve root pointer
         const uint8_t* msg  = data.data();
         auto           root = psio1::capnp_detail::resolve_struct_ptr(msg + 8);
...
static std::string capnp_tag_to_cpp(psio1::capnp_type_tag tag)
{
   switch (tag)
   {
      case psio1::capnp_type_tag::void_:
...
static std::string capnp_tag_to_rust(psio1::capnp_type_tag tag)
{
   switch (tag)
   {
      case psio1::capnp_type_tag::void_:
...
static std::string fbs_type_to_cpp(psio1::fbs_base_type type)
{
   switch (type)
   {
      case psio1::fbs_base_type::bool_:
...
static std::string fbs_type_to_rust(psio1::fbs_base_type type)
{
   switch (type)
   {
      case psio1::fbs_base_type::bool_:
...
static psio1::capnp_type_tag decode_list_element_tag(int32_t idx)
{
   if (idx < 0)
      return static_cast<psio1::capnp_type_tag>(-(idx + 1));
   return psio1::capnp_type_tag::struct_;  // positive = struct index
}

// Returns true for scalar types that should have {} default initializers in C++
static bool capnp_is_scalar(psio1::capnp_type_tag tag)
{
   switch (tag)
   {
      case psio1::capnp_type_tag::bool_:
...
static bool fbs_is_scalar(psio1::fbs_base_type type)
{
   switch (type)
   {
      case psio1::fbs_base_type::bool_:
...
static std::string capnp_field_type_cpp(const psio1::capnp_parsed_field& field,
                                        const psio1::capnp_parsed_file&  file)
{
   auto tag = field.type.tag;

   if (tag == psio1::capnp_type_tag::struct_)
   {
   ...
   if (tag == psio1::capnp_type_tag::enum_)
   {
      int32_t idx = field.type.referenced_type_idx;
...
static std::string capnp_field_type_rust(const psio1::capnp_parsed_field& field,
                                         const psio1::capnp_parsed_file&  file)
{
   auto tag = field.type.tag;
...
static std::string fbs_field_type_cpp(const psio1::fbs_field_def& field,
                                      const psio1::fbs_schema&    schema)
{
   if (field.type == psio1::fbs_base_type::table_ || field.type == psio1::fbs_base_type::struct_)
   {
   ...
   if (field.type == psio1::fbs_base_type::enum_)
   {
      if (field.type_idx >= 0 && field.type_idx < static_cast<int32_t>(schema.types.size()))
         return schema.types[field.type_idx].name;
      return "/* unknown enum */";
   ...
   if (field.type == psio1::fbs_base_type::vector_)
   {
      if (field.elem_type == psio1::fbs_base_type::table_ ||
          field.elem_type == psio1::fbs_base_type::struct_)
      {
...
static std::string fbs_field_type_rust(const psio1::fbs_field_def& field,
                                       const psio1::fbs_schema&    schema)
{
   if (field.type == psio1::fbs_base_type::table_ || field.type == psio1::fbs_base_type::struct_)
   {
...
static std::string codegen_capnp_cpp(const psio1::capnp_parsed_file& file,
...
static std::string codegen_capnp_rust(const psio1::capnp_parsed_file& file,
                                      const std::string&              source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
   out << "use psio1::{Pack, Unpack};\n";
   out << "\n";
...
static std::string codegen_fbs_cpp(const psio1::fbs_schema& schema,
                                   const std::string&      source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
   ...
   for (const auto& t : schema.types)
   {
      if (t.kind == psio1::fbs_type_kind::enum_)
      {
...
static std::string codegen_fbs_rust(const psio1::fbs_schema& schema,
                                    const std::string&      source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
...
static std::string capnp_field_type_go(const psio1::capnp_parsed_field& field,
                                       const psio1::capnp_parsed_file&  file)
{
   auto tag = field.type.tag;
...
static std::string capnp_field_type_ts(const psio1::capnp_parsed_field& field,
                                       const psio1::capnp_parsed_file&  file,
...
static std::string capnp_field_type_python(const psio1::capnp_parsed_field& field,
                                           const psio1::capnp_parsed_file&  file)
{
   auto tag = field.type.tag;
...
static std::string capnp_python_default(const psio1::capnp_parsed_field& field)
{
...
static std::string capnp_field_type_zig(const psio1::capnp_parsed_field& field,
                                        const psio1::capnp_parsed_file&  file)
{
   auto tag = field.type.tag;
...
static std::string capnp_zig_default(const psio1::capnp_parsed_field& field,
                                     const psio1::capnp_parsed_file&  file)
{
   switch (field.type.tag)
   {
...
static std::string fbs_field_type_go(const psio1::fbs_field_def& field,
                                     const psio1::fbs_schema&    schema)
{
   switch (field.type)
   {
      ...
      case psio1::fbs_base_type::vector_:
      {
         ...
         if (field.elem_type == psio1::fbs_base_type::string_)
            return "[]string";
         if (field.elem_type == psio1::fbs_base_type::uint8_)
            return "[]byte";
         // Build element type via recursion on a fake field
         psio1::fbs_field_def fake;
...
static std::string fbs_field_type_ts(const psio1::fbs_field_def& field,
                                     const psio1::fbs_schema&    schema,
                                     std::string*               comment = nullptr)
{
   switch (field.type)
...
static std::string fbs_field_type_python(const psio1::fbs_field_def& field,
                                         const psio1::fbs_schema&    schema)
{
   switch (field.type)
   {
...
static std::string fbs_python_default(const psio1::fbs_field_def& field)
{
   switch (field.type)
   {
      case psio1::fbs_base_type::bool_:
...
static std::string fbs_field_type_zig(const psio1::fbs_field_def& field,
                                      const psio1::fbs_schema&    schema)
{
   switch (field.type)
   {
...
static std::string fbs_zig_default(const psio1::fbs_field_def& field)
{
   switch (field.type)
   {
      case psio1::fbs_base_type::bool_:
...
static std::string codegen_capnp_go(const psio1::capnp_parsed_file& file,
                                    const std::string&              source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
...
static std::string codegen_fbs_go(const psio1::fbs_schema& schema,
                                  const std::string&      source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
...
static std::string codegen_capnp_ts(const psio1::capnp_parsed_file& file,
                                    const std::string&              source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n\n";
...
static std::string codegen_fbs_ts(const psio1::fbs_schema& schema,
                                  const std::string&      source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n\n";
...
static std::string codegen_capnp_python(const psio1::capnp_parsed_file& file,
                                        const std::string&              source_name)
{
   std::ostringstream out;
   out << "# Generated by psio-tool from " << source_name << "\n";
   ...
   for (const auto& s : file.structs)
   {
      ...
      for (const auto& f : s.fields)
      {
         ...
         if (f.type.tag == psio1::capnp_type_tag::struct_)
            py_t = "Optional[" + py_t + "]";
...
static std::string codegen_fbs_python(const psio1::fbs_schema& schema,
                                      const std::string&      source_name)
{
   std::ostringstream out;
   out << "# Generated by psio-tool from " << source_name << "\n";
   ...
   for (const auto& t : schema.types)
   {
      ...
      else
      {
         ...
         for (const auto& f : t.fields)
         {
            ...
            if (f.type == psio1::fbs_base_type::table_ || f.type == psio1::fbs_base_type::struct_)
               py_t = "Optional[" + py_t + "]";
...
static std::string codegen_capnp_zig(const psio1::capnp_parsed_file& file,
                                     const std::string&              source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
...
static std::string codegen_fbs_zig(const psio1::fbs_schema& schema,
                                   const std::string&      source_name)
{
   std::ostringstream out;
   out << "// Generated by psio-tool from " << source_name << "\n";
