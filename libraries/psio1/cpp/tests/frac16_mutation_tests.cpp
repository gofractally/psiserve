...
PSIO1_REFLECT(M16Simple, id, name, count)
...
PSIO1_REFLECT(M16AllFixed, definitionWillNotChange(), x, y, z)
...
PSIO1_REFLECT(M16MultiVar, id, first, second, third)
...
PSIO1_REFLECT(M16Address, street, city)
...
PSIO1_REFLECT(M16Person, id, addr, note)
...
{
   return psio1::to_frac16(v);
}

template <typename T>
using ref16_rw = psio1::frac16_ref<T, std::vector<char>>;
...
TEST_CASE("frac16 mutation: patch_mask correctness", "[fracpack16][mutation]")
{
   ...
   {
      using mask = psio1::frac_detail::patch_mask<M16MultiVar, 1, psio1::frac_format_16>;
   ...
   {
      using mask = psio1::frac_detail::patch_mask<M16MultiVar, 3, psio1::frac_format_16>;
          ...
          "[fracpack16][mutation][layout]")
{
   ...
   using Lsimple16  = psio1::frac_layout<M16Simple, psio1::frac_format_16>;
   ...
   using Lmulti16 = psio1::frac_layout<M16MultiVar, psio1::frac_format_16>;
   // id is u32 (4B), three string slots are u16 (2B) — mixed → not eligible.
   STATIC_REQUIRE(Lmulti16::simd_eligible == false);

   using Lfixed16 = psio1::frac_layout<M16AllFixed, psio1::frac_format_16>;
