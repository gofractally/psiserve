...
#include <psio1/capnp_schema.hpp>
...
PSIO1_REFLECT(SchemaPoint, definitionWillNotChange(), x, y)
...
PSIO1_REFLECT(SchemaToken, kind, offset, length, text)
...
PSIO1_REFLECT(SchemaUser, id, name, email, age, score, tags, verified)
...
PSIO1_REFLECT(SchemaLineItem, product, qty, unit_price)
...
PSIO1_REFLECT(SchemaOrder, id, customer, items, total, note)
...
PSIO1_REFLECT(SchemaShape, area, shape)
...
PSIO1_REFLECT(SchemaWithEnum, color, label)
...
PSIO1_REFLECT(SchemaDefaults, count, ratio, enabled, id)
...
PSIO1_REFLECT(SchemaContainer, points, ids, raw_data)

// ── Tests ───────────────────────────────────────────────────────────────────

TEST_CASE("capnp schema: simple struct with scalars", "[schema][cp]")
{
   auto schema = psio1::capnp_schema<SchemaPoint>();
...
{
   auto schema = psio1::capnp_schema<SchemaToken>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaOrder>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaShape>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaWithEnum>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaDefaults>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaContainer>();
   INFO("Generated schema:\n" << schema);
...
{
   auto schema = psio1::capnp_schema<SchemaUser>();
   INFO("Generated schema:\n" << schema);
...
TEST_CASE("capnp schema: deterministic IDs", "[schema][cp]")
{
   ...
   auto schema1 = psio1::capnp_schema<SchemaPoint>();
   auto schema2 = psio1::capnp_schema<SchemaPoint>();
